...
The [User Guide](../2_user_guide/index.qmd) walks the user through all the functionality of FloodAdapt.

The [API documentation](../4_api_docs/index.qmd) outlines the FloodAdapt API and provides executable example notebooks for use in python.
