...
- [8. Complex scenario(s)](scenarios/complex_scenario.ipynb) Provides an in-depth look at modeling compound flood scenarios involving multiple hazard sources (e.g., riverine and coastal flooding) and cascading impacts. Ideal for advanced users seeking to analyze intricate risk profiles.
