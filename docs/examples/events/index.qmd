...
[**Synthetic Event**](synthetic_event.ipynb): Programmatically defined using idealized or user-defined characteristics.

[**Historical Event**](historical_event.ipynb): Built from real-world observations or reanalysis data.
...
[**Database Manipulation**](database_manipulation.ipynb): Use the database to programmatically create a range of events to analyze the effects of different forcings.
