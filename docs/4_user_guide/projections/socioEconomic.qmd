...
![**Entering a percentage population growth in the existing built area**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/popGrowth_existingBuild.png){width=70% fig-align=left #fig-popGrowthExisting}
...
![**Simplification of population growth in the existing built area in FloodAdapt**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/popGrowth_existingBuild_proxyRep.png){width=70% fig-align=left #fig-popGrowthExistingProxy}
...
![**Entering a percentage population growth for a new development area**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/popGrowth_newDevelopment.png){width=70% fig-align=left #fig-popGrowthNew}
...
![**Implementation of population growth in new development areas in FloodAdapt**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/popGrowth_newDevelopment_implementation.png){width=70% fig-align=left #fig-popGrowthNewProxy}
...
![**Implementation of economic growth in FloodAdapt**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/economicGrowth.png){width=70% fig-align=left #fig-economicGrowth}
