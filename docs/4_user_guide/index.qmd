...
* The user can compare scenarios spatially (map comparison) in the [C**ompare - map**](compare/Compare_map.qmd) tab and can compare scenarios based on their tabulated metrics in the [**Compare - table**](compare/Compare_table.qmd) tab.
