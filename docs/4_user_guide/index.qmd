...
![**Tabs of the FloodAdapt user interface. Blue-grey fill indicates required user input, and the arrows show the flow of information from one tab to another.**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/GUI_Tabs.jpg){width=70% fig-align='left' #fig-GUItabs}
