...
When you first go to the Benfits tab in FloodAdapt you will see an empty table in the lower panel. Once you create benefit analyses these will appear in the table. To the right of the table there are buttons to add, edit, or delete a benefit analysis (see @fig-benefitEmpty). Before creating your first benefit analysis, only the 'Add benefit analysis' button is active.   

![**Benefit tab before any benefit analyses have been run**](../_static/images/benefitTab_empty.png){width=70% fig-align=left #fig-benefitEmpty}

This Benefits documentation will describe how to create a benefit analysis, how benefits are calculated, how to view benefit analysis output in the Benefits tab, and where you can find output on your computer for more detailed investigation. This information is described in the following sections:

* [how to create a new benefit analysis](#creating-a-new-benefit-analysis)
* [how benefits are calculated](#calculating-benefits)
* [how to view the benefit output in the Benefits tab](#viewing-benefit-output-in-the-benefits-tab)
* [which benefits-related output will be saved to your computer](#benefits-output-folder). 
...
![**The FloodAdapt Benefits tab**](../_static/images/Benefits_tab.png){width=80% fig-align=left #fig-benefitTab}
