...
![**Event template window for a historic event with gauged water levels.**](../C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/popup_syntheticEvent.png){#fig-syntheticWindow}
...
![**T=0 and the duration of a sythetic event**](../C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/syntheticEventDuration.png){#fig-syntheticDuration width=50% fig-align=left}
...
![**T=0 and the duration of a sythetic event**](../C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/PeakSurgeTiming.png){#fig-surgeTiming width=100% fig-align=left}
...
![**The three rainfall curves for a synthetic event. The top shows the Gaussian curve, the middle shows the SCS curve, and the bottom shows the block curve. All three represent three inches of rainfall over 12 hours (note: the vertical axis ranges are different in each plot)**](../C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/RainfallCurves.png){#fig-rainfallCurves width=40% fig-align=left}
