...
![**Hurricane selector window. You can search by name, and can filter the selection by distance to the site or time window**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/popup_hurricaneSelector.png){#fig-hurricaneSelector}
...
![**Event template window for a historical hurricane.**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/popup_hurricaneTemplate.png){#fig-hurricaneTemplate}
