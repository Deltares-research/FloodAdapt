...
![**Comparing map outputs for two scenarios. This example shows a compound high-tide and rainfall event from 2023 without sea level rise (left scenario) and with sea level rise (right scenario)**](../C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/comparison_map.png){width=100% fig-align=left #fig-comparisonMap}
...
![**Comparing metrics outputs for multiple scenarios. This example shows the metrics for current risk, risk with 1 foot of sea level rise, and risk with 1 foot of sea level rise and a flood wall implemented.**](../C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/Comparison_metrics.png){width=100% fig-align=left #fig-comparisonMetrics}
