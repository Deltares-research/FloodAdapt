...
The output folders for the event scenarios and risk scenarios have mostly the same structure. 
![**Folder structure of FloodAdapt database, showing where the output folder is located**](../../_static/images/output_folder_event.png){width=60% fig-align=left #fig-folderEvent}

![**Folder structure of FloodAdapt database, showing where the output folder is located**](../../_static/images/output_folder_risk.png){width=60% fig-align=left #fig-folderRisk}
