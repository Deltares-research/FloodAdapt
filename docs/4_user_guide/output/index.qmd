...
* **Aggregated damages** - show the damages summed up over different areas, such as census blocks or neighborhoods. The areas will correspond to the aggregation areas that are shown in the [site](C:/Users/rautenba/repos/FloodAdapt/docs/4_user_guide/site_tab.qmd) tab; these areas are specified at system setup. The aggregation drop-down menu to the right of the “Aggregated damages” check box can be used to switch between different areas.
...
![**Location of the "output" folder within the FloodAdapt folder structure**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/output_folderStructure.png){width=20% fig-align=left #fig-folderStruct_1}
:::
