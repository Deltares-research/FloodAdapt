...
![**Selecting an aggregation area for applying the green infrastructure option "greening".**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/measures_GI_greening.png){width=70% fig-align=left #fig-measures_buildingLevel_GUI}
...
![**Greening specification window**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/measures_GI_greening_specs.png){width=40% fig-align=left #fig-measures_waterSquare_specs}
