...
![**Hydraulic (grey) measures in FloodAdapt: floodwalls and levees, and pumps**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/measures_hydraulic.png){width=40% fig-align=left #fig-measures_buildingLevel}

![**Selection of Hydraulic measures in the Measures tab, shown here for the example of a floodwall**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/measures_hydraulic_GUI.png){width=70% fig-align=left #fig-measures_buildingLevel_GUI_h}
...
![**Implementing a floodwall in FloodAdapt by drawing a polyline**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/measure_floodwall_map.png){width=50% fig-align=left #fig-measures_floodwall_map}

![**Using the "show grid", "grid snapper" and topography layers to better specify your floodwall or levee**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/measure_floodwall_snapper_topo.png){width=50% fig-align=left #fig-measures_floodwall_snapper_topo}
...
![**Specifying information for a floodwall or levee**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/measure_floodwall_properties.png){width=50% fig-align=left #fig-measure_floodwall_properties}
...
![**Editing a floodwall or levee**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/measure_floodwall_edit.png){width=70% fig-align=left #fig-measure_floodwall_edit}
