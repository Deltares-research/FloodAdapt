...
![**Building-level adaptation measures in FloodAdapt: elevate, buyout, and floodproof properties**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/measures_buildingLevel.png){width=40% fig-align=left #fig-measures_buildingLevel}

![**Selection of Building measures in the Measures tab, shown here for the example of elevating buildings**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/measures_buildingLevel_GUI.png){width=70% fig-align=left #fig-measures_buildingLevel_GUI}
...
![**Specifying information for an elevate measure**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/measure_building_elevate_specification.png){width=50% fig-align=left #fig-measures_buildingLevel_elevate_spec}
...
![**Specifying information for a buyout measure**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/measure_building_poly_buyout_specification.png){width=50% fig-align=left #fig-measure_building_poly_buyout_specification}
...
![**Selecting buildings for applying the floodproofing measure**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/measure_building_poly_fp.png){width=70% fig-align=left #fig-measures_buildingLevel_fpPoly}
...
![**Specifying information for a floodproofing measure**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/measure_building_poly_fp_specification.png){width=50% fig-align=left #fig-measures_buildingLevel_fpPoly_spec}
