...
{{< video https://www.youtube.com/watch?v=3VmViLpo8_c?rel=0 >}}
...
![**The site tab, shown here for the example of Charleston, South Carolina**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/Tab_site.png){#fig-siteTab}
...
![**The site tab, zoomed out to show the full flood model extent (in red)**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/Tab_site_fullModelExtent.png){#fig-siteTab-zoomedOut}
