...
howto <- process_qmd("2_user_guide/index.qmd")
start <- process_qmd("2_user_guide/getting_started.qmd")
site <- process_qmd("2_user_guide/site_tab.qmd")
events <- process_qmd("2_user_guide/events/index.qmd")
historic_events <- process_qmd("2_user_guide/events/historic_events/index.qmd")
historic_events_h <- process_qmd("2_user_guide/events/historic_events/historic_events_hurricane.qmd")
historic_events_g <- process_qmd("2_user_guide/events/historic_events/historic_events_gauged.qmd")
historic_events_u <- process_qmd("2_user_guide/events/historic_events/historic_events_ungauged.qmd")
synthetic_events <- process_qmd("2_user_guide/events/synthetic_events.qmd")
probabilistic_events <- process_qmd("2_user_guide/events/probabilistic_events.qmd")
projections <- process_qmd("2_user_guide/projections/index.qmd")
projections_c <- process_qmd("2_user_guide/projections/climate.qmd")
projections_se <- process_qmd("2_user_guide/projections/socioEconomic.qmd")
measures <- process_qmd("2_user_guide/measures/index.qmd")
measures_h <- process_qmd("2_user_guide/measures/hydraulic.qmd")
measures_gi <- process_qmd("2_user_guide/measures/green_infra.qmd")
measures_b <- process_qmd("2_user_guide/measures/buildings.qmd")
strategy <- process_qmd("2_user_guide/strategy/index.qmd")
scenarios <- process_qmd("2_user_guide/scenarios/index.qmd")
output <- process_qmd("2_user_guide/output/index.qmd")
compare <- process_qmd("2_user_guide/compare/index.qmd")
benefits <- process_qmd("2_user_guide/benefits.qmd")
...
technical_docs <- process_qmd("3_technical_docs/index.qmd")
technical_docs_e <- process_qmd("3_technical_docs/EventScenario.qmd")
technical_docs_r <- process_qmd("3_technical_docs/RiskScenario.qmd")
technical_docs_eq <- process_qmd("3_technical_docs/EquityCalc.qmd")
technical_docs_b <- process_qmd("3_technical_docs/BenefitCalc.qmd")
