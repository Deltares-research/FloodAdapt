...
update_image_paths <- function(content) {
  ...
  updated_content <- gsub("\\.\\./\\..*/_static/images/", "C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/", content)
...
projections_se <- process_qmd("4_user_guide/projections/socioEconomic.qmd")
measures <- process_qmd("4_user_guide/measures/index.qmd")
measures_h <- process_qmd("4_user_guide/measures/hydraulic.qmd")
measures_gi <- process_qmd("4_user_guide/measures/green_infra.qmd")
...
technical_docs_b <- process_qmd("5_technical_docs/BenefitCalc.qmd")
