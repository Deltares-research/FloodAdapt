...
* Mean per capita income ($M$) and population $(P)$ at aggregated scale, for example census block groups. This information can be obtained automatically when setting up the [Delft-FIAT model](../3_setup_guide/Delft_Fiat/hydromt_fiat_gui.qmd)
