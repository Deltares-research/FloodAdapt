...
* **[User Guide](/2_user_guide/index.qmd)** The user guide provides information on how to get started with FloodAdapt, and describes how to use all the FloodAdapt functionalities.

* **[Setup Guide](/3_setup_guide/index.qmd)** - The setup guides users in setting up FloodAdapt in their area of interest.

* **[Technical docs](3_technical_docs/index.qmd)** - The technical docs provide detailed information on the calculation methods within FloodAdapt.
