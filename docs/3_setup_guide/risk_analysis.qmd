...
This guidance provides support for preparing an **event set** to be used in FloodAdapt to calculate probabilistic flood maps, impacts, and risk. An event set consists of a set of events, defined by variables like surge, tide, and rainfall, and their occurrence frequencies. To see how FloodAdapt uses an event set to calculate risk, take a look at the [FloodAdapt technical documentation on risk analysis](C:/Users/rautenba/repos/FloodAdapt/docs/5_technical_docs/RiskScenario.qmd), particularly the part about the [probabilistic calculator](C:/Users/rautenba/repos/FloodAdapt/docs/5_technical_docs/RiskScenario.qmd#probCalculator).
...
![**Observed annual mean sea levels, linear trend line from NOAA and fitted LOWESS trendline**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/eventSet_trendLine.png){width=50% fig-align=left #fig-trendLine}
...
![**Examples of the GEV and GPD and underlying distributions. The plots show the probability of exceedance of annual maxima (left) and Peaks Over Threshold (right). **](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/eventSet_GEV_GPD.png){width=50% fig-align=left #fig-GEVGPD}
...
![**Example fit of the GPD function to Peaks Over Threshold data.**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/eventSet_fittingGPD.png){width=50% fig-align=left #fig-fitGPD}
...
![**Example combination of an empirical distribution and an extreme value distribution.**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/eventSet_combiningDists.png){width=50% fig-align=left #fig-combiningDists}
...
![**Samples of hypothetical variables *x* and *y* for six different values of correlation coefficient .**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/eventSet_correlation.png){width=50% fig-align=left #fig-corr}
...
![**Illustration of four different copulas. In all cases the correlation coefficient was assumed to be 0.8.**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/eventSet_copulas.png){width=50% fig-align=left #fig-copulas}
...
![**Transformation from copula-variable y to storm surge variable s. F(s) is the cumulative probability distribution function of s.**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/eventSet_varTransform.png){width=50% fig-align=left #fig-varTransform}
...
![**Schematic view of selected grids for numerical integration.**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/eventSet_NIgrid.png){width=50% fig-align=left #fig-NIgrid}
...
![**Overview of the setup process for FloodAdapt**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/eventSet_folderDiagram.png){width=55% fig-align=left #fig-eventSet_folderDiagram}
...
![**Contents of an event folder (example)**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/eventSet_eventFolderContents.png){width=55% fig-align=left #fig-eventSet_eventFolderContents}
...
![**Example TOML file for an event named "event_0000"**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/eventSet_eventTOML.png){width=80% fig-align=left #fig-eventSet_eventTOML}
...
![**Example TOML file for an event**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/eventSet_probSetToml.png){width=100% fig-align=left #fig-eventSet_probSetToml}
...
Once the event set folder is created, you can reference it in the [database builder](C:/Users/rautenba/repos/FloodAdapt/docs/3_setup_guide/database.qmd) configuration file and it will be included in the FloodAdapt database so users can calculate risk and risk-reduction benefits of adaptation options.
