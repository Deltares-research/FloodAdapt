...
The attributes needed to include an SVI layer are described under 'Configuration file attributes' in the [Social vulnerability index section](#social-vulnerability-index-(svi)).
:::
...
The attributes needed to include a BFE layer are described under 'Configuration file attributes' in the [Base Flood Elevation section](#base-flood-elevation-(bfe)).
:::
