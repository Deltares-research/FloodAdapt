...
![**Adding an offshore model activates the ability to select a hurricane event, as well as an 'ungauged' historical event. Both of these event types make use of the offshore model. The left window shows the "Add event" popup window for the baseline FloodAdapt configuration, and the right shows with the addition of an offshore model**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/database_offshore.png){width=70% fig-align=left #fig-DB_offshore}

![**Hurricane selection window when a user has selected "NA" for North America as the 'cyclone basin'**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/database_cyclones_NA.png){width=70% fig-align=left #fig-DB_cyclonesNA}
...
![**Adding a tide gauge allows a user to activate the 'Download observed water levels' button. Additionally, it also allows users to specify different references they can view with the water level time series, and to set a different reference level ('zero') than mean sea level (MSL). The left window shows the baseline FloodAdapt configuration, and the right shows with the addition of a tide gauge.**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/database_comp_tideGauge.png){width=70% fig-align=left #fig-DB_comp_tideGauge}
...
FloodAdapt allows users to view modeled water level time series at observation points in the FloodAdapt [Output tab](C:/Users/rautenba/repos/FloodAdapt/docs/4_user_guide/output/index.qmd). The spatial flood map in the FloodAdapt Output tab is static and represents the maximum flood depth during an event. Having observation points helps users understand how the water levels evolved *during* an event. To activate this functionality, observation points can be added to the database-builder configuration file.

![**Adding observation points activates the functionality to view water level time series output at these points in the FloodAdapt [Output tab](C:/Users/rautenba/repos/FloodAdapt/docs/4_user_guide/output/index.qmd). The left window shows the baseline FloodAdapt configuration, and the right shows with the addition of observation points.**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/database_obsComp.png){width=100% fig-align=left #fig-DB_obscomp}
...
![**Adding a base flood elevation (BFE) layer activates the ability to elevate homes relative to BFE in addition to elevating relative to datum**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/database_bfe_comp.png){width=100% fig-align=left #fig-DB_obscomp}

### Sea level rise scenario selection
FloodAdapt allows users to explore the flooding and impacts for future sea level rise projections. In the base configuration case, users have access to this functionality, and can enter a sea level rise explicitly, for example "0.5 feet". However, FloodAdapt users may want to explore flooding and impacts at a specific point in the future, for example in 15 or 20 years, and they may not know the sea level rise to expect in that future year. To facilitate these users, a sea level rise scenario CSV file can be included in the database setup. There are many sources for sea level rise scenarios, such as the [interagency sea level task force](https://sealevel.globalchange.gov/resources/2022-sea-level-rise-technical-report/). There is no limit to the number of SLR scenarios a user can include. FloodAdapt uses this file to generate a visualization showing the different SLR scenario curves in the [Projections](C:/Users/rautenba/repos/FloodAdapt/docs/4_user_guide/projections/index.qmd) selection window. It also allows a user to enter a future year and select a SLR scenario, and then automatically calculates the sea level rise for that year.
...
![**Including a sea level rise scenario CSV file allows a user to select one of the SLR scenarios and a future year, and FloodAdapt automatically calculates the sea level rise**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/database_SLR_comp.png){width=100% fig-align=left #fig-DB_slrComp}
...
![**Snippet showing the mandatory attributes of the top of the configuration file**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/database_attr_baseline.png){width=100% fig-align=left #fig-DB_header}
...
![**Snippet showing the optional attributes of the top of the configuration file**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/database_header_optional.png){width=100% fig-align=left #fig-DB_header_optional}
...
### GUI attributes
![**Snippet showing the attributes of the GUI**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/database_GUI_snippet.png){width=100% fig-align=left #fig-DB_GUI}
...
![**Snippet showing the attributes of the baseline configuration**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/database_attr_BFs.png){width=100% fig-align=left #fig-DB_BFs}
...
![**Snippet showing the attributes of the tide gauge configuration**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/database_tideGauge_extended.png){width=100% fig-align=left #fig-DB_tideGauge}
...
![**Snippet showing the attributes of the SVI layer configuration**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/database_SVI.png){width=100% fig-align=left #fig-DB_SVI}
...
![**Snippet showing the attributes of the BFE layer configuration**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/database_bfe_snippet.png){width=100% fig-align=left #fig-DB_BFE}
...
![**Snippet showing the attributes of the SLR scenarios configuration**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/database_SLR_snippet.png){width=100% fig-align=left #fig-DB_slr}
...
![**Snippet showing an example of a SLR scenario CSV file**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/database_slr_csv.png){width=100% fig-align=left #fig-DB_slr_csv}
...
![**Snippet showing the attributes of the observation points configuration. In this example there are two observation points included. Each one begins with a the double-bracketed "obs_point" header**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/database_obs_snippet.png){width=100% fig-align=left #fig-DB_obs}
