...
* Double-click the "FloodAdaptModelBuilder_Installer" file and the setup wizard will open (see @fig-setupWizard). Follow the steps of the installation wizard.

![**FloodAdapt model-builder installation setup wizard**](C:/Users/rautenba/repos/FloodAdapt/docs/_static/images/installation_modelbuilders_setupWizard.png){width=50% fig-align=left #fig-setupWizard}
