...
Delft-FIAT works with an easy format for exposed assets, consisting of information on the location, exposed value, ground floor height, and associated depth-damage functions, which can be modified by the user.
...
The FloodAdapt Model Builder obtains these vulnerability curves from two different data sources:
