...
<u>*Step-by-step instructions: Get started*</u> 
  ...
  4. Generate the model boundary (@fig-boundaries).
        ...
        c) **SFINCS model domain**: If you already created a SFINCS model you can select the **/gis-folder**. Do <u>not</u> select the region file itself. It will be recognized automatically by the model.
...
If you wish to add any **aggregation** layer or **additional attribute** layer to your model follow these instructions. The same instructions apply for any SVI and/or equity layer. 
