...
The videos below show the exposure setup using the National Structure Inventory (NSI) database (@fig-nsi_exposure) and the Open  Street Map (OSM) database for roads(@fig-osm_exposure).
...
2. **JRC Vulnerability Curves (global)**
