...
These are steps that are carried out whether you do quick build or tailored model-building. After you open the Delft-FIAT model-builder you must select a model output directory before you start.
...
*Step-by-step instructions for the tailored Delft-FIAT model*  
