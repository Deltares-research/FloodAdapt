...
The **quickbuild** is a complete Delft-FIAT model which can be set up anywhere in the **United States** with ease. It doesn't require any user input except for defining the model boundary.  
Additionally to the base model and roads, the [social vulnerability index](#sec-svi) is generated as well as [equity](#sec-svi) is downloaded.
...
<u>*Step-by-step instructions for the Quick Build*</u> 
  ...
  1. Go to the **Model Boundary | Quickbuild**-tab and select any of the options in the drop-down menu to create the boundary (@sec-getting-started; @fig-quickbuild).
  2. After you generated the boundary you can select the quickbuild option and the model will be built.
...
To setup the exposure data you have multiple options to refine your model, which are described in the following sections:

  - Create a base model with the default data sources(#sec-basemodel)
  - [Update Finished Floor Height](#sec-finished_floor_height) (*optional*)
  - [Update Finished Ground Elevation](#sec-ground_elevation)(*optional*)
  - [Update Maximum Potential Damages](#sec-maximum_potential_damages)(*optional*)

Not all steps are required to build the model, except the creation of the base model. Simply update the data you wish to change and use the default data of the base model for any data you do not have.
...
<u>*Step-by-step instructions to setup the exposure data*</u>   
...
<u>*Step-by-step instructions to setup/update the Finished Floor Height*</u>  
