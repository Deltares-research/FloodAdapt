...
Delft-FIAT is data agnostic; what you put in is what you get out. Please follow the guidelines in this documentation to build your FIAT model and pay close attention to the validation of data together with local experts.
...
## Folder structure
We recommened to follow the folder structure as shown below for your model to ensure that FIAT can find each data file and run smoothly. 
```
├───📁 FIAT/
    |
    ├───📁 hazard/
...
The **exposure data** describe the assets within the region of interest. FIAT allows **vector and raster data** inputs. 
