...
To view the output of your scenario you can proceed to the [Output](../output/index.qmd) tab. To compare scenarios you can make use of the [Compare - map](../compare/index.qmd) and [Compare - table](../compare/index.qmd) tabs.
