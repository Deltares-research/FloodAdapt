from flood_adapt.object_model.direct_impact.socio_economic_change.risk_driver_factory import (
    RiskDriverFactory,
)
...
class SocioEconomicChange:
    ...
    def set_default(self) -> None:
        ...
        self.population_growth_existing = RiskDriverFactory.get_risk_drivers(
            "population_growth_existing"
        )
        self.population_growth_new = RiskDriverFactory.get_risk_drivers(
