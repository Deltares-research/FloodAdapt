...
# Added for TCs
from flood_adapt.object_model.hazard.event.cht_scripts.tropical_cyclone import TropicalCyclone
...
#        module = __import__(self.source.module_name)
        module = importlib.import_module("flood_adapt.object_model.hazard.event.cht_scripts." + self.source.module_name) #Changed by Tim de Wilde
