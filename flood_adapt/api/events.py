...
def create_historical_nearshore_event() -> dict(): # gives back empty  object to populate pop-up window, different options for discharge are in the class #TODO: ask Julian
    pass
...
def check_delete_event() -> bool:#, str: # str contains full error message, empty if False
    pass
