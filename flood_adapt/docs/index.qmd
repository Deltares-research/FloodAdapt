...
**bold**: ** word ** (remove tab spaces betweenw asteriks and word)
...
Let's see what happends when I add the 2 tabs: 
...
Use the asteriks for your first level. For the second level in the row below add an indentation and a + per entry. 
...
add a figure and give it a name add #fig..to corss-reference.  Just included here for demonstration purposes): 
