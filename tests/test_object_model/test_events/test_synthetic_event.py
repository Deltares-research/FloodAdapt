...
# from tests.test_object_model.test_events.test_event_models import (
#     TestSyntheticEventModel,
# )
...
#     @staticmethod
#     def get_test_event():
#         event_model = TestSyntheticEventModel.get_test_model()
#         event = EventFactory.load_dict(event_model)
#         return deepcopy(event)

#     @staticmethod
#     def get_test_event_model():
#         event_model = SyntheticEventModel.model_validate(
#             TestSyntheticEventModel.get_test_model()
#         )
