...
def test_create_new_event():
    ...
    assert isinstance(test_event.water_level_offset, UnitfulValue)
...
def test_create_new_synthetic():
    ...
    assert isinstance(test_synthetic.duration_before_t0, float)
    assert isinstance(test_synthetic.duration_after_t0, float)
    assert isinstance(test_synthetic.water_level_offset, UnitfulValue)
    assert isinstance(test_synthetic.tide, TideModel)
...
def test_read_config_synthetic():
    ...
    assert isinstance(test_synthetic.name, str)
    assert isinstance(test_synthetic.long_name, str)
    assert isinstance(test_synthetic.mode, str)
    assert isinstance(test_synthetic.template, str)
    assert isinstance(test_synthetic.timing, str)
    assert isinstance(test_synthetic.duration_before_t0, float)
    assert isinstance(test_synthetic.duration_after_t0, float)
